...
def main():
    ...
    with col[1]:
        ...
        if poblacion_5_anos_inmigrante != 0 and poblacion_5_anos_emigrante != 0 and poblacion_nacida_otro_pais_residente_mexico != 0 and poblacion_nacida_otro_pais_residente_mexico_hombres != 0 and poblacion_nacida_otro_pais_residente_mexico_mujeres != 0:
            ...
            fig = go.Figure(data=[
                go.Bar(name='Población', x=migration_data['Tipo'], y=migration_data['Población'], marker_color='rgba(199, 56, 189, 0.8)', width=[0.8, 0.8]),
    ...
    with col[2]:
        ...
        if (population_0_4 != 0 and population_0_4_males != 0 and population_0_4_females != 0 and 
            ...
            fig = go.Figure(data=[
                ...
                go.Scatter(name='Población masculina', x=age_data['Edad'], y=age_data['Población masculina'], mode='lines', line=dict(color='rgba(58, 166, 185, 0.8)', width=5)),
                go.Scatter(name='Población femenina', x=age_data['Edad'], y=age_data['Población femenina'], mode='lines', line=dict(color='rgba(255, 158, 170, 0.8)', width=5))
            ])
